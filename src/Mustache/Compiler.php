...
class Mustache_Compiler
{
     ...
     */
    public function compile($source, array $tree, $name, $customEscape = false, $charset = 'UTF-8', $parent = 'Mustache_Template')
    {
        $this->pragmas        = array();
        $this->blocks         = array();
        $this->sections       = array();
    ...
    private function writeCode($tree, $name)
    {
        ...
        return sprintf($this->prepare(self::KLASS, 0, false), $require, $name, $this->parent, $body, $blocks, $sections);
    }
